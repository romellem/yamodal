(function () {
   ...
   * @param {String} [opt.close_selector] Selector of the element(s) that when clicked, close its open modal. Defaults to '[data-modal-close]'. If the modal does not contain a an element matching `[data-modal-close]` then the modal itself will close when clicked.
  ...
  var initializeModalListener = function initializeModalListener() {
    ...
    var destroy = function destroy() {
      ...
      var noop = function noop() {
        return console.log("yamodal instance was destroyed, returned methods can no longer be called.");
      };
